...
{   
    ...
    SDL_Surface *background = NULL,*playy=NULL,*settingg=NULL,*quit,*fish1,*fish2,*fish3,*fish4,*fish5,*fish0;
    SDL_Rect positionbackground,positionplay,positionsetting,positionquit,positionClic,positionfish0,positionfish1,positionfish2,positionfish3,positionfish4,positionfish5;
    SDL_Event event;
int i;
    ...
    positionplay.x=359.5;
    positionplay.y=179.5;

    settingg=IMG_Load("boutton_setting.png");
    positionsetting.x=778.5;
    positionsetting.y=179.5;

    quit=IMG_Load("boutton_exit.png");
    positionquit.x=587.5;
    positionquit.y=350.5;
   //animation 
    fish0=IMG_Load("unnamed.png");
positionfish0.x=1160.5;
positionfish0.y=179.5;
fish1=IMG_Load("unnamed2.png");
positionfish1.x=1160.5;
positionfish1.y=179.5;
fish2=IMG_Load("unnamed3.png");
positionfish2.x=1160.5;
positionfish2.y=179.5;
fish3=IMG_Load("unnamed4.png");
positionfish3.x=1160.5;
positionfish3.y=179.5;
fish4=IMG_Load("unnamed5.png");
positionfish4.x=1160.5;
positionfish4.y=179.5;
fish5=IMG_Load("unnamed6.png");
positionfish5.x=1160.5;
positionfish5.y=179.5;
			...
			break;
                ...
                case SDL_MOUSEBUTTONUP:
                         ...
                         if (event.button.button == SDL_BUTTON_LEFT)
		         {
                    ...
                    if(event.button.x >395.5 && event.button.x <587.5 && event.button.y >179.5&& event.button.y <350.5)
                            {play(ecran,son,musique);}

                     else if(event.button.x >778.5&& event.button.x <969.5&& event.button.y >179.5&& event.button.y <350.5)
                            {setting(ecran,son,musique);}

                     else if (event.button.x >587.5&& event.button.x <778.5 && event.button.y >350.5&& event.button.y <521.5)
                                {continuer=0; }
...
case SDL_MOUSEMOTION:
      if (event.motion.x >395.5 && event.motion.x < 587.5 && event.motion.y > 179.5 && event.button.y < 350.5)
      {
        p=2;
      
        texte = TTF_RenderText_Blended(policeBig, "New game,It will be fun", couleurblanche);
        positionTxt.x = 50;
        positionTxt.y = 700;
        SDL_BlitSurface(texte, NULL, ecran, &positionTxt);
        SDL_Flip(ecran);
        SDL_Delay(0); //evite de faire sauter l image
      }
      else if (event.motion.x > 778.5 && event.motion.x<969.5 && event.motion.y > 179.5 && event.button.y < 350.5)
      {   ex=2;

          texte=TTF_RenderText_Blended(policeBig,"option",couleurblanche);
          positionTxt.x= 50;
          positionTxt.y= 700;
          SDL_BlitSurface(texte,NULL,ecran,&positionTxt);
          SDL_Flip(ecran);
      ...
      else if (event.motion.x > 587.5 && event.motion.x<778.5 && event.motion.y > 350.5 && event.button.y < 521.5)
      {   set=2; 
        
          texte=TTF_RenderText_Blended(policeBig,"exit",couleurblanche);
          positionTxt.x= 50;
          positionTxt.y= 700;
          SDL_BlitSurface(texte,NULL,ecran,&positionTxt);
          SDL_Flip(ecran);
    ...
    else if (event.motion.x != 395.5 && event.motion.x!=587.5 && event.motion.y !=  179.5 && event.button.y != 350.5 && event.motion.x != 778.5 && event.motion.x!=587.5 && event.motion.y != 179.5 && event.button.y != 350.5 && event.motion.x != 587.5 && event.motion.x != 778.5 && event.motion.y !=350.5 && event.button.y != 521.5){
...
set=1; 
   ...
   SDL_Flip(ecran);
     ...
     break;
        ...
        SDL_BlitSurface(quit, NULL, ecran, &positionquit);
        SDL_BlitSurface(fish0, NULL, ecran, &positionfish0);
SDL_BlitSurface(fish1, NULL, ecran, &positionfish1);
SDL_BlitSurface(fish2, NULL, ecran, &positionfish2);
SDL_BlitSurface(fish3, NULL, ecran, &positionfish3);
SDL_BlitSurface(fish4, NULL, ecran, &positionfish4);
SDL_BlitSurface(fish5, NULL, ecran, &positionfish5);
			...
			break;
                ...
                case SDL_MOUSEBUTTONUP:
		         ...
		         {//if case
                    ...
                    if(event.button.x >340&& event.button.x <531 && event.button.y >310&& event.button.y <481)
                            {choose(ecran,son,musique);}

                     else if(event.button.x >750&& event.button.x <941 && event.button.y >310&& event.button.y <481)
                            {/*jouer(ecran);*/}

                     else if (event.button.x >20&& event.button.x <211 && event.button.y >25&& event.button.y <196)
                                {menu(ecran,musique);}
			...
			break;
                ...
                case SDL_MOUSEBUTTONUP:
                         ...
                         if (event.button.button == SDL_BUTTON_LEFT)
		         {
                             positionClic.x = event.button.x ;
                             positionClic.y = event.button.x;
                    if(event.button.x >100&& event.button.x <293 && event.button.y >310&& event.button.y <481)
                            {ecran = SDL_SetVideoMode(800, 600,32, SDL_HWSURFACE | SDL_DOUBLEBUF);}


                     else if(event.button.x >530&& event.button.x <720 && event.button.y >310&& event.button.y <481)
                            {ecran = SDL_SetVideoMode(1280, 720,32, SDL_HWSURFACE | SDL_DOUBLEBUF);}

                     else if(event.button.x >960&& event.button.x <1150 && event.button.y >310&& event.button.y <481)
                            {ecran = SDL_SetVideoMode(1366, 768,32, SDL_HWSURFACE | SDL_DOUBLEBUF);}
                ...
                case SDL_MOUSEBUTTONUP:
                         ...
                         if (event.button.button == SDL_BUTTON_LEFT)
		         {
                    ...
                    if(event.button.x >100&& event.button.x <293 && event.button.y >310&& event.button.y <481)
                     ...
                     else if(event.button.x >525&& event.button.x <720&& event.button.y >310&& event.button.y <481)
                            {/*jouer_clavier();*/}
...
while (continuer)
    {
		...
		case SDLK_LEFT :
			...
			break;
			 ...
			 if(event.button.x >102&& event.button.x <293 && event.button.y >310&& event.button.y <481)
                            {Mix_VolumeChunk(son, MIX_MAX_VOLUME);Mix_VolumeMusic(MIX_MAX_VOLUME*4);}
			...
			else if(event.button.x >958&& event.button.x <1149&& event.button.y >310&& event.button.y <481)
                            {Mix_VolumeChunk(son, MIX_MAX_VOLUME/2);Mix_VolumeMusic(MIX_MAX_VOLUME/4);}
